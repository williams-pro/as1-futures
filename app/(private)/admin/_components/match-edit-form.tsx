...
import { updateMatch } from '@/app/actions/admin/matches/update-match'
...
type UpdateMatchFormData = z.infer<typeof UpdateMatchSchema>
...
export function MatchEditForm({ match, onSuccess, onCancel }: MatchEditFormProps) {
  ...
  const onSubmit = async (data: UpdateMatchFormData) => {
    try {
      setLoading(true)
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle>Edit Match</CardTitle>
            <CardDescription>Update match information</CardDescription>
          </div>
